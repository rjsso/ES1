...
public class Interface_Window {
	...
	public void evaluateManual() {
		...
		if(hamList==null || rulesList==null || spamList==null) {
			...
			Message msg= new Message("Manual configuration","Manual configuration FP and FN updated");
			msg.sendMessage();
	...
	public void evaluateAuto() {
		...
		if(hamList==null || rulesList==null || spamList==null) {
			...
			Message msg= new Message("Auto configuration","Auto configuration FP and FN updated");
			msg.sendMessage();
